...
export const minLength = (minLength: number, message: any) => (value: string) => value?.length < minLength ? message : '';

export const maxLength = (maxLength: number, message: any) => (value: string) => value?.length > maxLength ? message : '';
